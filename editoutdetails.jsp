...
<%
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/airtel","root","tiger");
...
<tr><td align=right ><b><font size=4>Amount:&nbsp;&nbsp;</b></td>
	<td align=left >&nbsp;&nbsp;<input type="text" name="amt" size="20" style="width: 165" value="<%=rs.getString(6)%>"></td></tr>
