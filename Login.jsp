...
<!--
	javascript:window.history.forward(window.history.length);
function fun()
{
document.LoginForm.username.focus();
}

	function setSubmit(LoginForm)
	{
		...
		{
			document.LoginForm.eventAction.value = "signin";
			return true;
		}
	}
	function setReset(LoginForm)
	{
            ...
            <tr>
              ...
              <td bgcolor="F3F3F3" valign="top" width="288">
				<div align="left"><br><span class="style8">LOGIN</span></div>
				  <form name="LoginForm" method="post" action="/airtel/login" >
				  ...
				  <tr><td colspan="2">&nbsp;</td></tr>
				   <tr>
					...
					<input src="images/but_login.gif" border="0" height="30" type="image" width="85" onClick="return setSubmit(this)">
					<input src="images/but_reset.gif" border="0" height="30" type="image" width="80" onClick="return setReset(this)"></td>
				   </tr>
